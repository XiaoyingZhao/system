		...
		case 'miaopaiapp_list':
			switch(req.query.act){
				case 'mod':
					var data={};
					(async () => {
					    data.layout_mod_data = await getAllData.getModData.miaopaiaAPP_mod_data(req.query.id);
					    
					    data.layout_data = await getAllData.getData.miaopaiAPP_data(8);
					    
					    res.render('web/layout', {data});
					})();
				...
				case 'del':
					(async () => {
						...
						res.redirect('/guifan/admin/miaopaiapp/layout');
					})();
