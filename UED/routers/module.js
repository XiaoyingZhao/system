		...
		case 'miaopaiapp_list':
			switch(req.query.act){
				case 'mod':
					var data={};
					(async () => {
					    data.module_mod_data = await getAllData.getModData.miaopaiaAPP_mod_data(req.query.id);
					    
					    data.module_data = await getAllData.getData.miaopaiAPP_data(7);
					    
					    res.render('web/module', {data});
					})();
				...
				case 'del':
					(async () => {
						...
						res.redirect('/guifan/admin/miaopaiapp/module');
					})();
