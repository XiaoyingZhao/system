		...
		case 'miaopaiapp_list':
			switch(req.query.act){
				case 'mod':
					var data={};
					(async () => {
					    data.version_mod_data = await getAllData.getModData.miaopaiaAPP_mod_data(req.query.id);
					    
					    data.version_data = await getAllData.getData.miaopaiAPP_data(11);
					    
					    res.render('web/version', {data});
					})();
				...
				case 'del':
					(async () => {
						...
						res.redirect('/guifan/admin/miaopaiapp/version');
					})();
