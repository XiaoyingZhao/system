		...
		case 'miaopaiapp_list':
			switch(req.query.act){
				case 'mod':
					var data={};
					(async () => {
					    data.standard_word_mod_data = await getAllData.getModData.miaopaiaAPP_mod_data(req.query.id);
					    
					    data.standard_word_data = await getAllData.getData.miaopaiAPP_data(3);
					    
					    res.render('web/standard-word', {data});
					})();
				...
				case 'del':
					(async () => {
						...
						res.redirect('/guifan/admin/miaopaiapp/standard-word');
					})();
		...
		case 'miaopaiapp_second_list':
			switch(req.query.act){
				case 'mod':
					var data = {};
					(async()=>{
						data.standard_word_second_mod_data = await getAllData.getModData.miaopaiaAPP_mod_data(req.query.id);
