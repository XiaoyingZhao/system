		...
		case 'miaopaiapp_list':
			switch(req.query.act){
				case 'mod':
					var data={};
					(async () => {
					    data.button_mod_data = await getAllData.getModData.miaopaiaAPP_mod_data(req.query.id);
					    
					    data.button_data = await getAllData.getData.miaopaiAPP_data(5);
					    
					    res.render('web/button', {data});
					})();
				...
				case 'del':
					(async () => {
						...
						res.redirect('/guifan/admin/miaopaiapp/button');
					})();
